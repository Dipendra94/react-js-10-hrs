...
function Form({type,id}){
    ...
    const fetchProduct = async()=>{
        const response = await axios.get("https://66dc8f4547d749b72acbeac5.mockapi.io/products/" + id)
    ...
    const createProduct  = async (e)=>{
        e.preventDefault()
        if(type === "create"){
            const response = await axios.post("https://66dc8f4547d749b72acbeac5.mockapi.io/products",data)
            ...
            const response = await axios.put("https://66dc8f4547d749b72acbeac5.mockapi.io/" +id,data)
            if(response.status=== 200){
                navigate("/product/"+id)
            }else{
                alert("Edit vayena!!")
